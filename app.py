...
st.caption("Write your custom function, click run, and test messages below!")
...
# 2. Build the top-to-bottom interactive interface
...
# Place the action button directly beneath the code box
run_clicked = st.button("🚀 Run & Test Code", type="primary")

# Initialize a session state flag to remember if the user has clicked run
...
# 3. Only show the testing inputs and results after the button is clicked
